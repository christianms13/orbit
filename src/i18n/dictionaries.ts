export const dictionaries = {
  en: {
    ...
    "optimal-path-results.desktop-summary.total-degrees": "total degrees",
    "optimal-path-results.desktop-summary.total-runtime": "total runtime",
    "optimal-path-results.desktop-title": "connection path found",
